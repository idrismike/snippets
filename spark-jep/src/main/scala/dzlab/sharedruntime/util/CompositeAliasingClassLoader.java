...
/**
 * #resource http://www.java2s.com/Code/Java/Language-Basics/ClassLoaderthatiscomposedofotherclassloaders.htm
 ...
 *
 * <h1>Example</h1>
 * <pre><code>CompositeAliasingClassLoader loader = new CompositeAliasingClassLoader();
 ...
 * @since 1.0.3
 */
public class CompositeAliasingClassLoader extends ClassLoader {

    private final List classLoaders = Collections.synchronizedList(new ArrayList());

    public CompositeAliasingClassLoader() {
    ...
    public Class loadClass(String name) throws ClassNotFoundException {
        ...
        if(name.startsWith("io_yields"))
            name = name.replace("io_yields", "io.yields");
